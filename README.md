...
orange_core.py: Motor numérico que integra as equações diferenciais parciais (PDE) hiperbólicas amortecidas por meio de discretização de Verlet de 2ª ordem e controle não-linear adaptativo de 
κ
κ.
...
orange_app.py: Painel visual de controle no Streamlit que renderiza a malha dimensional em 3D, plota a convergência temporal das energias, ajusta e compara os dados galácticos com cálculo de 
χ
2
χ 
2
  reduzido e emite Laudos Técnicos automatizados de sanidade física.
